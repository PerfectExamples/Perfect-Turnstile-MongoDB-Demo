...
The library can be found at [https://github.com/PerfectlySoft/Perfect-Turnstile-MongoDB](https://github.com/PerfectlySoft/Perfect-Turnstile-MongoDB)
...
* Open `PerfectTurnstileMongoDBDemo.xcodeproj`
...
* Execute `swift build`
* Once the project has compiled, execute `./.build/debug/PerfectTurnstileMongoDBDemo`
